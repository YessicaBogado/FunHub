...
var funhub_services = angular.module("funhub.services", ["ngResource"]);

funhub_services.factory("Sensor", ["$resource", function ($resource) {
...
funhub_services.factory("Text", function () {
    var text = {
        text_blocks_map: {},
...
//XMPP methods
funhub_services.factory("XMPP", ["$location", "$timeout", "Graph", "Text", function ($location, $timeout, Graph, Text) {
...
funhub_services.factory("User", ["XMPP", "$rootScope", function (xmpp, $rootScope) {
    var user = {
        init: function () {
            user.registries = [];
            user.favorites = [];
