...
var funhub_directives = angular.module('funhub.directives', []);

funhub_directives.directive('favorite', function (User) {
    return {
        restrict: 'A',
...
funhub_directives.directive('chart', function (Graph) {
    return {
        restrict: 'A',
        template: '',
...
funhub_directives.directive('text', function (Text) {
    return {
        restrict: 'A',
        template: '',
        link: function ($scope, element) {
...
funhub_directives.directive('navbar', function() {
    return {
...
funhub_directives.directive('log', function ($location, $timeout, XMPP, User, $cookies) {
    return {
        restrict: 'A',
        templateUrl: 'partials/blocks/login_modal.html',
        link: function ($scope, element, attrs) {
            $scope.xmpp = XMPP;
            $scope.process = "";
